PreProcPkg_v5_3 MATLAB Python Package
...
2. Installing the PreProcPkg_v5_3 Package

A. Change to the directory that contains the file setup.py and the subdirectory 
PreProcPkg_v5_3. If you do not have write permissions, copy all its contents to a 
...
3. Using the PreProcPkg_v5_3 Package
...
The PreProcPkg_v5_3 package is on your Python path. To import it into a Python script or 
session, execute:

    import PreProcPkg_v5_3
